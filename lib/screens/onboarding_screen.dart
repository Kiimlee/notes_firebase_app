...
class OnboardingScreen extends StatefulWidget {
  static MaterialPage page() {
    return MaterialPage(
      name: NotesPages.onboardingPath,
      key: ValueKey(NotesPages.onboardingPath),
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget buildPages() {
    return PageView(
      ...
      children: [
        onboardPageView(
          const AssetImage('assets/notes.png'),
          '''Check out weekly recommended recipes and what your friends are cooking!''',
        ),
        onboardPageView(const AssetImage('assets/notes.png'),
